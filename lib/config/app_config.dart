...
class AppConfig {
  ...
  // 5. 외부 API 키
  //
  // 카카오 책 검색 REST API 키 (표지 자동 검색에 사용 · 일 30,000회 무료)
  // 키 재발급: https://developers.kakao.com → 내 애플리케이션 → REST API 키
  // ⚠️ 앱 배포 시 이 키는 추출될 수 있습니다. 카카오 콘솔에서
  //    플랫폼(iOS 번들 ID) 제한을 걸어두세요.
  // ──────────────────────────────────────────────────────────────────────────
  static const String kakaoRestApiKey = 'dd7fa6ed314f1a7c2bb1550b2e053df3';

  // ──────────────────────────────────────────────────────────────────────────
  // 6. Phase 3 연결 포인트 (Supabase + RevenueCat)
  //
